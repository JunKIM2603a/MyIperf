...
public:
    ...
    /**
     * @brief Starts the packet generation and sending process using coroutines.
     * @param config The configuration settings for the test.
     * @return A Task that represents the sending coroutine.
     */
    Task sendPackets(const Config& config);
...
private:
    /**
     * @brief Creates a packet and returns it as a vector.
